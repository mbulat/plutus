...
module Plutus
  describe Transaction do
    ...
    it "should not be valid without a credit account" do
      transaction = FactoryGirl.build(:transaction, :credit_account => nil)
      transaction.should_not be_valid
    end

    it "should not be valid without a valid credit account" do
      bad_account = FactoryGirl.build(:asset, :name => nil)
      transaction = FactoryGirl.build(:transaction, :credit_account => bad_account)
      transaction.should_not be_valid
    end

    it "should not be valid without a debit account" do
      transaction = FactoryGirl.build(:transaction, :debit_account => nil)
      transaction.should_not be_valid
    end

    it "should not be valid without a valid credit account" do
      bad_account = FactoryGirl.build(:asset, :name => nil)
      transaction = FactoryGirl.build(:transaction, :debit_account => bad_account)
      transaction.should_not be_valid
    end

    it "should not be valid without an amount" do
      transaction = FactoryGirl.build(:transaction, :amount => nil)
      transaction.should_not be_valid
    end

    it "should not be valid without a description" do
      transaction = FactoryGirl.build(:transaction, :description => nil)
      transaction.should_not be_valid
    end
